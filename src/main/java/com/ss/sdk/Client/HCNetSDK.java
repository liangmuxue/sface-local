...
//2007-11-30 V211支持以下接口 //11
    ...
    public static class NET_DVR_CONTROL_GATEWAY extends Structure{
        ...
        public byte[] byControlSrc = new byte[NAME_LEN];
        public byte byControlType;
        public byte[] byRes3 = new byte[3];
        public byte[] byPassword = new byte[PASSWD_LEN];
    ...
    public static class NET_DVR_VIDEO_INTERCOM_EVENT extends Structure {
        ...
        public void read() {
            ...
            switch (byEventType) {
                case 1:
                    uEventInfo.setType(NET_DVR_UNLOCK_RECORD_INFO.class);
                    break;
                case 2:
                    uEventInfo.setType(NET_DVR_NOTICEDATA_RECEIPT_INFO.class);
                    break;
                case 3:
                    uEventInfo.setType(NET_DVR_AUTH_INFO.class);
                    break;
                case 6:
                    uEventInfo.setType(NET_DVR_SEND_CARD_INFO.class);
                    break;
                default:
                    break;
            }
